...
dump(X_train_transformed, 'processed_telco_churn_data/X_train.joblib')
dump(X_test_transformed, 'processed_telco_churn_data/X_test.joblib')

dump(y_train, 'processed_telco_churn_data/y_train.joblib')
dump(y_test, 'processed_telco_churn_data/y_test.joblib')
...
dump(xgboost_optimal, 'model/fitted_xgboost.joblib')
